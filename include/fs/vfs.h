...
struct inode_operations
{
    ...
    int (*readdir)(struct inode *, size_t offset, struct dentry *);
...
struct file_operations
{
    ...
    size_t (*read)(struct inode *inode, void *buf, size_t size, size_t offset);
    // called by write(2) and related system calls
    size_t (*write)(struct inode *inode, void *buf, size_t size, size_t offset);
    // called by the close(2) system call to flush a file
    int (*close)(struct file *);
    // called by the mmap(2) system call
    void (*mmap)(struct file *);
    ...
    size_t (*trunc)(struct inode *inode, size_t len);
};
